...
namespace Compendium.Helpers.Prefabs
{
    public static class PrefabHelper
    {
        private static readonly Dictionary<PrefabName, string> m_Names = new Dictionary<PrefabName, string>()
        {
            ...
            [PrefabName.Scp244a] = "SCP244APickup",
            [PrefabName.Scp244b] = "SCP244BPickup",
            ...
            [PrefabName.Scp268Pedestal] = "Scp268PedestalStrcture Variant",
        ...
        private static void LoadPrefabs()
        {
            ...
            {
                Plugin.Debug($"Loading prefab: {prefab.name}");

                if (m_Names.TryGetKey(prefab.name, out var prefabType))
                {
                    m_Prefabs[prefabType] = prefab;

                    Plugin.Debug($"Prefab loaded: {prefabType} ({prefab.name})");
                }
                else
                {
