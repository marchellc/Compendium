...
namespace Compendium.Helpers.Staff
{
    public static class StaffHelper
    {
        ...
        public static void LoadStaff()
        {
            ...
            Plugin.Debug($"Loading members from {FilePath} ..");
            ...
            foreach (var line in lines)
            {
                ...
                Plugin.Debug($"Loaded staff member {uid}: {group}");
            }
        ...
        private static void Notify(ReferenceHub hub, bool added)
        {
            ...
            if (added)
                hub.ShowMessage($"Your server role was assigned.", 5f, true);
            else
                hub.ShowMessage($"Your server role was removed.", 5f, true);
        }
